...
{
    public partial class _106Sreuture : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessOrder", x => new { x.BusinessesId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_BusinessOrder_Businesses_BusinessesId",
                        column: x => x.BusinessesId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusinessOrder_Orders_OrdersId",
                        column: x => x.OrdersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessOrder_OrdersId",
                table: "BusinessOrder",
                column: "OrdersId");
